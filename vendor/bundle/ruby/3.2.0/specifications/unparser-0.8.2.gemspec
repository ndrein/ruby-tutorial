...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/mbj/unparser/issues", "changelog_uri" => "https://github.com/mbj/unparser/blob/main/Changelog.md", "funding_uri" => "https://github.com/sponsors/mbj", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/mbj/unparser" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<prism>.freeze, [">= 1.5.1"])
  s.add_development_dependency(%q<benchmark>.freeze, ["~> 0.5.0"])
  s.add_development_dependency(%q<mutant>.freeze, ["~> 0.14.2"])
  s.add_development_dependency(%q<mutant-rspec>.freeze, ["~> 0.14.2"])
  s.add_development_dependency(%q<rspec>.freeze, [">= 3.13", "< 5"])
  s.add_development_dependency(%q<rspec-core>.freeze, [">= 3.13", "< 5"])
